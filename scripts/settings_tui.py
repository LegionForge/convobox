...
SECTION_SPECS: tuple[SectionSpec, ...] = (
    SectionSpec(
        ...
        fields=(
            ...
            FieldSpec("audio", "aec_ns_level", "NS level (advanced)", "int", help_text="Advanced. Only matters if Noise suppression above is on. 0=low, 1=moderate, 2=high, 3=very high (WebRTC APM's own enum). 2 (high) is the tested value from the 2026-08-31 trial referenced above -- that's the one with real measured results behind it, not the other three levels."),
